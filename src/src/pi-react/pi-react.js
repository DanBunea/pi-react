...
exports.__ = function translate(key){
...
exports.pi_change= pi_change;
exports.pi_change_multi= pi_change_multi;
exports.pi_move= pi_move;
exports.pi_delete= pi_delete;
exports.pi_copy= pi_copy;
exports.pi_value= pi_value;
exports.info= info;

exports.shallow_clone = shallow_clone;
exports.ajax=ajax;
exports.simple_ajax=simple_ajax;
exports.ajax_no_promise=ajax_no_promise;
exports.debug = debug

exports.change = R.curry(function(path, val, obj){info("pi.change",path, val);return pi_change(obj, path, val)});
exports.change_multi = R.curry(function(changes, obj){info("pi.change_multi",changes);return pi_change_multi(obj, changes)});
exports.value = R.curry(function(path, obj){info("pi.value: ",path);return pi_value(obj, path)});
exports.copy = R.curry(function(path1, path2, obj){info("pi.copy",path1, path2);return pi_copy(obj, path1, path2)});
exports.delete = R.curry(function(path, obj){info("pi.delete",path);return pi_delete(obj, path)});
exports.move = R.curry(function(path1, path2, obj){info("pi.move",path1, path2);return pi_move(obj, path1, path2)});

exports.swap_model_add_history=swap_model_add_history;
exports.swap_model=swap_model;
exports.debounce =debounce;

exports.equals=equals;
exports.retain_changes=retain_changes;
exports.id=function(state){console.log("id:", state);return state;}
exports.stateful_mixin = stateful_mixin;